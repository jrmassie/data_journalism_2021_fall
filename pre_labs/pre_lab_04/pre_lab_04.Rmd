...
**Answer**
The data can't be merged on the column because it's recognizing the values as two different types of data.
```{r}
...
**Answer**
44,032 PPP loans went out to the non-hispanic white population. The average amount is $53,836.46 and the median amount is $20,000.
```{r}
...
**Answer**
The average amount for rural zipcodes with a more than 50% non-hispanic Black population is $44,328.87. The median is $19,621. The average amount for urban zipcodes with a more than 50% non-hispanic Black population is $53,868.53. The median is $20,000.
```{r}
...
**Answer**
The average amount for rural zipcodes with a more than 50% non-hispanic white population is $73,694.14. The median is $20,833. The average amount for urban zipcodes with a more than 50% non-hispanic white population is $90,911.14. The median is $20,833.
```{r}
