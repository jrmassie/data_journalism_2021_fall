...
**Answer**
The city names have mixed casings. 
```{r}
...
**Answer**
Changed ABELL to Abell, made the Aberdeens teh same casing, changed casing of ABERDEEN PROVING GROUND to Aberdeen Proving Ground.
```{r}
cleaned_md_loans %>%
